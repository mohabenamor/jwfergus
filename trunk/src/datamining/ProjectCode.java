...
public class ProjectCode {
    ...
    /**
     * @param args the command line arguments - None now.
     */
    ...
    public static void main(String[] args) {
        ...
        String inputFileName = System.getProperty("user.dir") + "\\src\\datamining\\samples\\yemen.tsv";
        ...
        try {
            ...
            while ((stringReader = bufferedReader.readLine()) != null) {
                 ...
                 */
                ArrayList<String> textAsArray = StringUtilities.stripTextIntoArray(text);
                /*
